 ...
 */
public class FragmentAllUserNotification extends Fragment {


    public FragmentAllUserNotification() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_alluser_notification, container, false);
        mFirestore=FirebaseFirestore.getInstance();
        try{
            recyclerView=view.findViewById(R.id.id_rv_frAllUser_notification);
                    ...
                    .addSnapshotListener(getActivity(), new EventListener<QuerySnapshot>() {
                        ...
                        public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                            ...
                            for(DocumentChange doc:queryDocumentSnapshots.getDocumentChanges()){
                                ...
                                if(messageInformation.getType().equals("User")){
