 ...
 */
public class FragmentAllManagerNotification extends Fragment {


    public FragmentAllManagerNotification() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_allmanager_notification, container, false);
        mFirestore=FirebaseFirestore.getInstance();
        try{
            recyclerView=view.findViewById(R.id.id_rv_frAllManager_notification);
                    ...
                    .addSnapshotListener(getActivity(), new EventListener<QuerySnapshot>() {
                        ...
                        public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                            ...
                            for(DocumentChange doc:queryDocumentSnapshots.getDocumentChanges()){
                                ...
                                if(messageInformation.getType().equals("Manager")){
