...
public class ActivityMoneyReciveAllMember extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {

    TextView txt_admin,txt_manager,txt_user;
    ViewPager pager;
    ViewPagerAdpaterMoneyRecive pagerAdapter;
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getSupportActionBar().hide();
        setContentView(R.layout.activity_money_recive_all_member);
        ...
        pagerAdapter=new ViewPagerAdpaterMoneyRecive(getSupportFragmentManager());
