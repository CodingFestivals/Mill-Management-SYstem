 ...
 */
public class FragmentAllManagerMoneyRecive extends Fragment {
    ...
    public FragmentAllManagerMoneyRecive() {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        try {
            ...
            recyclerView = view.findViewById(R.id.id_rv_frAllManager);
                        ...
                        public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                            ...
                            for(DocumentChange doc:queryDocumentSnapshots.getDocumentChanges()){
                                if(doc.getType()== DocumentChange.Type.ADDED){
                                    ...
                                    boolean managerMatch=userId.equals(currentUserId);
                                    //show all admin
                                    boolean typeMatch=user.getType().equals("Manager");
                                    //show logger messid information
                                    boolean messIdMatch=messId[0].equals(messIdValue);
                                    if(!managerMatch&&typeMatch&&messIdMatch){
                                        arrayList.add(user);
