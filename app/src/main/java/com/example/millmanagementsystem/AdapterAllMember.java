...
public class AdapterAllMember extends RecyclerView.Adapter<AdapterAllMember.MyViewHolder>{

    Context context;
    ArrayList<ImageInformation> arrayList;

    public AdapterAllMember(Context context, ArrayList<ImageInformation> arrayList) {
        this.context = context;
        this.arrayList = arrayList;
    }

    public AdapterAllMember.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterAllMember.MyViewHolder myViewHolder, int i) {
